...
const Order = () => {
  ...
  return (
    <>
      ...
      >
        <Navbar />
        <section className="h-[40vh] flex items-end justify-center">
          ...
          <div className={`${inriasans.className} rounded-md p-6 grid md:grid-cols-2 gap-6 bg-white bg-opacity-50`}>
            <div>
              <div>
                ...
                <input type="text" id="nama" name="nama" value={form.nama} onChange={handleChange} placeholder="Nama" className="mt-1 p-3 w-full rounded-lg border-gray-200 shadow-sm sm:text-sm" />
              </div>
              <div className="mt-3">
                <label htmlFor="tanggal" className="block font-medium text-gray-700">
                  Tanggal
                </label>
                <input type="date" id="tanggal" name="tanggal" value={form.tanggal} onChange={handleChange} placeholder="Pilih Tanggal" className="mt-1 p-3 w-full rounded-lg border-gray-200 shadow-sm sm:text-sm" />
              </div>
              <div className="mt-3">
                <label htmlFor="alamat" className="block font-medium text-gray-700">
                  Alamat
                </label>
                <input type="text" id="alamat" name="alamat" value={form.alamat} onChange={handleChange} placeholder="Alamat" className="mt-1 p-3 w-full rounded-lg border-gray-200 shadow-sm sm:text-sm" />
              </div>
              <div className="mt-3">
                <label htmlFor="email" className="block font-medium text-gray-700">
                  Email
                </label>
                <input type="email" id="email" name="email" value={form.email} onChange={handleChange} placeholder="john@rhcp.com" className="mt-1 p-3 w-full rounded-lg border-gray-200 shadow-sm sm:text-sm" />
              </div>
            </div>
            <div>
              <div>
                ...
                <select name="layanan" id="layanan" value={form.layanan} onChange={handleChange} className="mt-1.5 p-3 w-full rounded-lg border-gray-300 text-gray-700 sm:text-sm">
              ...
              <p className="text-xs mt-2">*Jika ada yang perlu ditambahkan lagi tentang order anda, silahkan hubungi kami via WhatsApp ke 0856-4106-4464.</p>
              <div className="flex mt-6">
                <button onClick={handleSubmit} className="bg-black text-[#B79C55] px-8 py-2 rounded-lg leading-6 text-center hover:bg-[#B79C55] hover:text-white transition duration-300 ease-in-out">
                  Kirim
                </button>
              </div>
            </div>
