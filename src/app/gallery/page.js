    ...
    <>
      ...
      <section className="">
        <div className=" bg-[#A68541] lg:bg-gradient-to-r from-[#A68541] to-[#F1D87B00]" style={{ backgroundImage: "')", backgroundSize: 'cover', backgroundPosition: 'center' }}>
          <div className="min-h-[60vh] flex flex-col justify-center lg:w-[500px] pt-14 px-6 lg:px-0 lg:ps-16" data-aos="fade-right" data-aos-duration="2500">
      ...
      <div className="gallery  py-20 px-2 lg:px-6">
        <div className="grid grid-cols-3 gap-2 lg:gap-4">
          {/* 1-2 */}
          <div className="col-span-2" data-aos="fade-up" data-aos-duration="2500">
          ...
          <div className="grid grid-rows-2 gap-2">
            <div data-aos="fade-up" data-aos-duration="2500" data-aos-delay="100">
          ...
          {/*  */}
          {/* 3 */}
          <div className="" data-aos="fade-up" data-aos-duration="2500" data-aos-delay="100">
          ...
          <div className="" data-aos="fade-up" data-aos-duration="2500" data-aos-delay="500">
