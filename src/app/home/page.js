...
const images = ['/images/display.png', '/images/gallery-compressed/foto1.jpg', '/images/gallery-compressed/foto3.jpg'];
    ...
    <>
      ...
      >
        <div className=" mx-auto grid md:grid-cols-2 pt-4 items-center px-4 lg:px-20">
          <div className="md:order-2 bg-[#EEEEEEB2] p-4 lg:p-10 rounded-xl" data-aos="fade-left" data-aos-duration="3000">
          ...
          <div className="md:order-1 lg:ms-10" data-aos="fade-right" data-aos-duration="3000">
      ...
      <div style={{ background: 'linear-gradient(135deg, #B79C55, #ffffff)' }}>
        <section className="py-10 text-center">
          <div className="goldenText px-7 py-2 lg:py-5 text-xl lg:text-3xl mb-5" data-aos="fade-down" data-aos-duration="3000">
            <span className={inriaserif.className}>PAKET LAYANAN KAMI</span>
          </div>
          <p className=" lg:text-lg px-4 mb-10 font-medium text-white" data-aos="fade-down" data-aos-duration="3000">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 px-4 lg:px-32">
            <div className="relative" data-aos="fade-up" data-aos-duration="3000" data-aos-delay="100">
            ...
            <div className="relative" data-aos="fade-up" data-aos-duration="3000" data-aos-delay="200">
            ...
            <div className="relative" data-aos="fade-up" data-aos-duration="3000" data-aos-delay="300">
            ...
            <div className="relative" data-aos="fade-up" data-aos-duration="3000" data-aos-delay="400">
            ...
            <div className="relative" data-aos="fade-up" data-aos-duration="3000" data-aos-delay="500">
            ...
            <div className="relative" data-aos="fade-up" data-aos-duration="3000" data-aos-delay="600">
        ...
        <section className="py-10 text-white text-center ">
          ...
          <div className="px-2 lg:px-20" data-aos="fade-right" data-aos-duration="3000" data-aos-delay="1000">
            <img src="/images/KostumDanKonsep.png" alt="Wedding Party" className="rounded-lg w-full" />
          </div>
          <div className="px-4">
            <div className="goldenText px-3 lg:px-7 py-2 lg:py-5 text-xl lg:text-3xl mt-20 mb-5" data-aos="fade-down" data-aos-duration="3000">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 px-4 lg:px-32">
            ...
            <div data-aos="fade-up" data-aos-duration="3000" data-aos-delay="400">
              <button className="bg-gradient-to-r from-[#B64C45] to-[#561a0b] text-white font-semibold px-4 py-2 rounded-3xl mb-2 w-full">
            ...
            <div data-aos="fade-up" data-aos-duration="3000" data-aos-delay="600">
              <button className="bg-gradient-to-r from-[#B64C45] to-[#561a0b] text-white font-semibold px-4 py-2 rounded-3xl mb-2 w-full">
      ...
      <section className="text-center" data-aos="fade-right" data-aos-duration="3000">
      ...
      >
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center px-4">
          <div className="w-[400px] md:w-1/2 p-4 " data-aos="fade-right" data-aos-duration="3000">
            <iframe
          ...
          <div className="md:w-1/2 p-4" data-aos="fade-left" data-aos-duration="3000">
